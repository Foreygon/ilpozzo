...
class Categorie
{
    ...
    #[ORM\OneToMany(mappedBy: 'categorie', targetEntity: Lacarte::class)]
    ...
    public function addCategorie(Lacarte $categorie): self
    {
    ...
    public function removeCategorie(Lacarte $categorie): self
    {
